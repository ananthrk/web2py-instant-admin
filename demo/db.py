...
auth.settings.hmac_key = 'sha512:080478dc-40d2-48d7-8233-2ce301a92a72'   # before define_tables()
...
# A table to test all field types
db.define_table('survey',
    ...
    Field('lucky_numbers', 'list:integer'),
...
db.survey.lucky_numbers.requires=IS_IN_SET(range(10))
